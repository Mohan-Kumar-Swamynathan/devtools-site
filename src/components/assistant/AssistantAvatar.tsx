  ...
  return (
    <div
      className={clsx(
        ...
        mood === 'listening' && 'animate-pulse-soft',
        mood === 'thinking' && 'animate-wiggle',
    ...
    >
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        {mood !== 'thinking' ? (
          <>
            <ellipse cx="38" cy="45" rx={mood === 'listening' ? 6 : 5} ry={mood === 'listening' ? 6 : 5} fill="white" />
            <circle cx="38" cy="45" r="2.5" fill="#1e293b" />
            <ellipse cx="62" cy="45" rx={mood === 'listening' ? 6 : 5} ry={mood === 'listening' ? 6 : 5} fill="white" />
        ...
        {mood === 'listening' && <ellipse cx="50" cy="64" rx="6" ry="4" fill="white" />}
        {mood === 'speaking' && <ellipse cx="50" cy="64" rx="8" ry="6" fill="white" className="animate-mouth" />}
        ...
        <circle cx="50" cy="2" r="4" fill={mood === 'listening' ? '#22c55e' : '#60a5fa'} />
      </svg>
